# USM Tournois - Documentation Technique
...
└── CLAUDE.md               # Ce fichier - Documentation technique
```
...
- **Contrôleur** : `server/src/controllers/admin.elimination.controller.ts` - Génération et classement
